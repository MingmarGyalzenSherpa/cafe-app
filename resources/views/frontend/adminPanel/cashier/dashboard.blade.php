...
<div class="container p-3 border border-primary" style="margin-top:90px;text-align:center">
    ...
    <div class="container d-flex flex-wrap">
          @foreach ($tables as $table)
                ...
                ">
                    <a href="{{route('billDashboard',$table->id)}}" class="border d-flex justify-content-center align-items-center" style="font-weight:bold; font-size: 3rem;color:white;width:100%;height:100%;"><span>{{$table->table_name}}</span></a>
                </div>
          @endforeach
